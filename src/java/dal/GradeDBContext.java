...
public class GradeDBContext extends DBContext<Grade> {
    ...
    public ArrayList<Grade> getGradesByStudentId(int sid) {
        ...
        PreparedStatement stm = null;
        try {
            String sql = "SELECT g.eid, g.sid, g.score, e.aid, a.aname, a.weight "
                    + "FROM grades g "
    ...
    public ArrayList<Grade> getGradesByCourseIdAndStudentId(int cid, int sid) {
        ArrayList<Grade> grades = new ArrayList<>();
        PreparedStatement stm = null;
        try {
            String sql = "SELECT g.eid, g.sid, g.score, e.aid, a.aname, a.weight "
                       ...
                       + "INNER JOIN exams e ON g.eid = e.eid "
                       + "INNER JOIN assesments a ON e.aid = a.aid "
                       + "INNER JOIN courses c ON c.subid = a.subid "
