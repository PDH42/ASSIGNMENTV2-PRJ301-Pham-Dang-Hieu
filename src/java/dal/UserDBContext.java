...
public class UserDBContext extends DBContext<User> {
    ...
    public User getUserByLectuere(String username) {
        User user = null;
        try {
            String sql = "SELECT l.lname AS LecturerName, u.username, u.displayname, u.email, u.phone, u.address "
    ...
    public User getUserByStudent(String username) {
        User user = null;
        try {
            String sql = "SELECT s.sname AS StudentName, u.username, u.displayname, u.email, u.phone, u.address\n"
                    + "FROM dbo.students s\n"
