            ...
            <div class="container mt-5">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <ul class="list-group">
                            <li class="list-group-item"><a href="${pageContext.request.contextPath}/student/exam" class="btn btn-success">View Exam</a></li>
                            <li class="list-group-item"><a href="${pageContext.request.contextPath}/student/schedule" class="btn btn-success">View Schedule</a></li>
